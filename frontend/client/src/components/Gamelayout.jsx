...
<div className="NextRoundButton"> <button> GO TO NEXT ROUND </button></div>
<div className="WrongAnswer2">Player 2 Wins</div>
</div>

<div className="PlayerInput1"><input type="text" placeholder='Input Team 1'/></div>
        <div className="Player1ScoreTab">Team 1</div>
        <div className="Player1Score"><input type="text" placeholder='Zero'/></div>

<div className="PlayerInput2"><input type="text" placeholder='Input Team 2'/></div>
        <div className="Player2ScoreTab">Team 2</div>
        <div className="Player2Score"><input type="text" placeholder='Zero'/></div>
